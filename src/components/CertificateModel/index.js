  ...
  return (
    <Container>
      <Content>
        <h1>CERTIFICADO</h1>
        <div id="text">
          <p>Certificamos que <b> Administrador </b> participou do Curso de
            <b> Auxiliar Administrativo, </b>
            realizado nesta Universidade por meio do Centro de Formação Profissional, no período de
            <span> 20 de Janeiro de 2020 </span> a
            <span> 30 de Março de 2021</span>, com carga horária
            total de <span>80 (oitenta)</span> horas-aula.
          </p>
